              ...
              <div className="space-y-3">
                {[1, 2, 3, 4, 5, 6, 7, 8].map((i) => (
                  <div key={i} className="bg-card border border-border rounded-xl p-4 md:p-6">
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4 items-center animate-pulse">
                      <div className="flex items-center gap-3">
                        <div className="w-10 h-10 md:w-12 md:h-12 rounded-full bg-muted/50" />
                      ...
                      <div className="space-y-2">
                        <div className="h-5 bg-muted/50 rounded w-1/2 ml-auto" />
                      </div>
                    </div>
                  </div>
                ))}
