    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center pointer-events-none">
      ...
      >
        <div className="relative bg-gradient-to-br from-slate-900/98 via-blue-900/98 to-purple-900/98 
          ...
          <motion.button
            onClick={onClose}
            className="absolute top-3 right-3 sm:top-4 sm:right-4 z-20 p-1.5 rounded-full 
                       bg-background/80 backdrop-blur-sm border border-border/50
                       hover:bg-slate-700/80 transition-all duration-200 opacity-90 hover:opacity-100 hover:scale-110"
          ...
          >
            <div className="space-y-3">
              <motion.h2 
                className="text-3xl md:text-4xl font-bold bg-gradient-to-r from-white via-blue-100 to-purple-100 
              ...
              <motion.p 
                className="text-blue-200/90 text-lg md:text-xl font-medium flex items-center justify-center gap-2"
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
              ...
              <motion.p 
                className="text-blue-300/80 text-sm md:text-base px-4"
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
            ...
            <motion.div 
              className="space-y-5 pt-6 border-t border-blue-400/30"
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row justify-center gap-3 sm:gap-4 px-2">
                <motion.button
                  ...
                  className="flex items-center justify-center space-x-2 px-5 py-3.5 
                           bg-[#5865F2]/20 hover:bg-[#5865F2]/30 
                           border border-[#5865F2]/40 rounded-xl transition-all duration-200
                           shadow-lg hover:shadow-[#5865F2]/20"
                ...
                <motion.button
                  ...
                  className="flex items-center justify-center space-x-2 px-5 py-3.5 
                           ...
                           shadow-lg hover:shadow-[#0088cc]/20"
                  whileHover={{ scale: 1.05, y: -2 }}
                  whileTap={{ scale: 0.95 }}
                  initial={{ opacity: 0, x: 20 }}
                  animate={{ opacity: 1, x: 0 }}
