...
const PricingPlans = () => {
  return <section className="py-20 px-6 bg-muted/30">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          delay: index * 0.1
              ...
              {plan.popular && <Badge className="absolute -top-3 left-1/2 -translate-x-1/2 bg-primary text-primary-foreground rounded-none py-0 mx-0 my-0 px-0">
                  Most Popular
                </Badge>}
