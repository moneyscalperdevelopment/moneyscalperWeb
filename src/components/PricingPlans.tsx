...
const PricingPlans = () => {
  ...
  return <section className="py-20 px-6 bg-gradient-to-br from-background via-primary/5 to-background">
      <div className="max-w-7xl mx-auto">
        ...
        duration: 0.6
          ...
          <h2 className="text-4xl font-bold mb-4 bg-gradient-to-r from-blue-400 via-cyan-400 to-blue-500 bg-clip-text text-transparent py-[30px] md:text-6xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-8">
          ...
          delay: index * 0.1
              ...
              {plan.popular && <Badge className="absolute -top-2 left-1/2 -translate-x-1/2 bg-gradient-to-r from-blue-500 to-purple-600 text-white border-0 px-6 py-1.5 text-sm font-bold shadow-lg shadow-blue-500/50 z-10">
                  Most Popular
                </Badge>}
